...
<template>
  ...
  <section class="bg-[#0D5649]">
    <h3 class="services_title pt-2 mb-6">Additional Services</h3>

    <div v-for="service in servicesStore.data">
...
.post-it{
  z-index: 9999;
  margin-left: -20%;
  background: linear-gradient(0deg, #D8D27D 30%, #726F42 100%);
  opacity: 80%;
}
.post-it-reverse{
  z-index: 9999;
